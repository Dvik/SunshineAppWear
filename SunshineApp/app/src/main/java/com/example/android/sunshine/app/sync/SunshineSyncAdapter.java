...
import com.example.android.sunshine.app.listener.SunshineWearListener;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter
    ...
    private static final int INTERVAL = 60 * 180;
    private static final int FLEX = INTERVAL/3;
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                updateMuzei();
                notifyWeather();
                // GoogleApiClient should connect and then if connected, update the wearable
    ...
    /**
     * This updates the wearable if one is connected with the current forecast for today by
     * triggering <code>SunshineWearListener</code> to start
     */
        ...
        if(mGoogleApiCLient.isConnected()) {
            new Thread() {
                ...
                public void run() {
                    ...
                    Node localNode = getLocalNodeResult.getNode();
                    Wearable.MessageApi.sendMessage(
                            mGoogleApiCLient,
                            localNode.getId(),
                            SunshineWearListener.PATH,
                            SunshineWearListener.MSG.getBytes()).await();
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        SunshineSyncAdapter.configurePeriodicSync(context, INTERVAL, FLEX);
